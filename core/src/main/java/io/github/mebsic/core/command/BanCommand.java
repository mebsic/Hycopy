...
import io.github.mebsic.core.model.BanReasonType;
...
public class BanCommand implements CommandExecutor {
    ...
    public BanCommand(CorePlugin plugin, PunishmentService punishments) {
        this.plugin = plugin;
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        BanReasonType reasonType = BanReasonType.fromCode(args[reasonIndex]);
        if (reasonType == null) {
    ...
    private void sendInvalidUsage(CommandSender sender) {
        ...
        for (BanReasonType type : BanReasonType.values()) {
