...
public final class CommonMessages {
    ...
    public static final String PROFILE_LOADING = "Your profile is loading!";
    public static final String TARGET_PROFILE_LOADING_COMMAND = "That player's profile is loading!";
}
